...
/**
 * The pre-redesign journey page, preserved verbatim at /journey/v1 so the
 * original composition stays reachable while /journey serves the redesign.
 */
export default function JourneyV1(): React.ReactElement {
  return (
