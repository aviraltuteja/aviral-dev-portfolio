...
/**
 * The pre-redesign landing page, preserved verbatim at /v1 so the original
 * composition stays reachable while `/` serves the redesign.
 */
export default function HomeV1(): ReactElement {
  return (
