...
/**
 * The pre-redesign contact page, preserved verbatim at /contact/v1 so the
 * original composition stays reachable while /contact serves the redesign.
 */
export default function ContactPageV1() {
