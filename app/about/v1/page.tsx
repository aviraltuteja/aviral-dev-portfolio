...
/**
 * The pre-redesign about page, preserved verbatim at /about/v1 so the original
 * composition stays reachable while /about serves the redesign.
 */
export default function AboutUsPageV1(): React.ReactElement {
  return (
    <SmoothScroll>
